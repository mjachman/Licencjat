...
namespace VetAppointment.Data.Migrations
{
    ...
    [Migration("20210614233534_saddsa")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VetAppointment.Models.Entry", b =>
                {
                    ...
                    b.Property<int?>("ParentEntryEntryID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VetAppointment.Models.Entry", b =>
                {
                    b.HasOne("VetAppointment.Models.Identity.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId");

                    b.HasOne("VetAppointment.Models.Entry", "ParentEntry")
                        .WithMany()
                        .HasForeignKey("ParentEntryEntryID");
                });
